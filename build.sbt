...
lazy val root = (project in file(".")).enablePlugins(PlayScala).aggregate(aceJsProject, js).dependsOn(shared, grammarComparison)
...
lazy val grammarComparison = RootProject(uri("https://github.com/epfl-lara/GrammarComparison.git#8ec8e25090ec3e133f055680580160bb24d83917"))
